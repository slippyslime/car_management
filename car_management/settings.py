...
from django.conf.global_settings import APPEND_SLASH, STATICFILES_DIRS, STATIC_ROOT
...
SECRET_KEY = 'django-insecure-56naa7ibq$+#2(gawz%@4=c=+07nnb=r)gm5fkk^y*)2$wpgp2'
